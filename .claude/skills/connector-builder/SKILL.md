...
## Hard rules
- Connect requests read + write scopes at OAuth consent with plain-language explanation (C8). Execution of write side effects is gated at runtime by the owner-set action level (Observe/Draft/Act); Agent School is advisory.
