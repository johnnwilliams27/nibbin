...
// ============================================================================
// Database Conversion (optional feature — db feature removed; screenpipe-db
// was never vendored and Nibbin uses its own DB path)
// ============================================================================

// to_db_insert removed along with the db feature.
