...
- Nibbins do the work, and only by drafting. Every draft waits for the person's approval before anything happens. A Nibbin earns more independence only through Agent School: its accuracy is scored on the drafts the person approves, edits, or rejects.
