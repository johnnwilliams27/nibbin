  ...
  const flameSvg = isGrad
    ...
    : sr
      ? flame(
          u,
          color,
          `M100 74 C91 64 96 60 93 50 C91 45 96 41 100 36 C104 41 109 45 107 50 C106 60 109 64 100 74 Z`,
          `M100 70 C95 63 98 59 96 52 C100 56 101 62 100 68 Z`,
          100, 54, 16,
        )
      : flame(
          u,
          color,
          `M100 66 C86 50 94 42 89 28 C86 20 94 14 100 6 C106 14 114 20 111 28 C106 42 114 50 100 66 Z`,
          `M100 60 C92 50 96 42 94 32 C100 40 102 50 100 56 Z`,
          100, 36, 24,
        );
