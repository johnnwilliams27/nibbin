      ...
      <div className="wrap foot-in">
        ...
        <div className="foot-links">
          ...
          <span className="foot-social">
            <a
              href="https://www.tiktok.com/@getnibbin"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Nibbin on TikTok"
            >
            ...
            <a
              href="https://www.instagram.com/get_nibbin"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Nibbin on Instagram"
            >
              <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
            ...
            <a
              href="https://x.com/getnibbin"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Nibbin on X"
            >
              <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
