...
export const HELP_CONTENT: HelpContent = [
  // --- GETTING STARTED (fully authored) ------------------------------------
  {
    ...
    intro:
      "Nibbin gives you a grove of little helpers — Nibbins — that learn how you work and take routine chores off your plate. You decide what each one may do (Observe, Draft, or Act); Agent School grades how well it is doing so you always know when to extend more trust. Four moves get you there: sign in → run a Field Study → read your diagnosis → approve drafts.",
    articles: [
      {
        id: "gs-what-is-nibbin",
        q: "What is Nibbin, in plain language?",
        body:
          "Nibbin is a grove of little AI helpers that privately learn how you work, tell you where your time goes, and grow small agents (“Nibbins”) that take routine chores off your plate. Each helper is built from your patterns — not generic templates. You grant what each Nibbin may do (Observe, Draft, or Act); Agent School grades how accurately it is working so you always know when to trust it with more.",
