      ...
      <body>
        ...
        >
          <div style={{ maxWidth: '28rem', padding: '32px 24px', textAlign: 'center' }}>
            <h1 style={{ fontSize: '23px', marginBottom: '8px' }}>Something went wrong</h1>
            <p style={{ color: 'var(--ink-soft)', marginBottom: '24px' }}>
              The console hit an error it could not recover from. The error has
              been logged. Try again — if it keeps happening, give it a minute.
            </p>
            <button
              onClick={reset}
              style={{
