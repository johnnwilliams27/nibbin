...
with open('fp_a_remote_roles.md','w') as fh:
    ...
    fh.write(f"- **Companies that errored / no public ATS:** {errored_direct} fallback cos (token unresolved — likely Rippling/Workable/BambooHR/custom, or no open board)\n\n")
