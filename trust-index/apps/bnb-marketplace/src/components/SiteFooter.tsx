  ...
  return (
    <footer className="site-footer">
      <div className="page-wrap site-footer-inner">
        <div><Link href="/" className="font-semibold">Nibbin BNB Agent Marketplace</Link><p className="mt-2 text-[13px] text-[var(--fg-muted)]">© 2026 Nibbin · Direct-chain registration snapshot.</p></div>
