...
export default tseslint.config(
  {
    ignores: [
      ...
      'fixtures/snapshots/**',
      '**/.next/**',
      // Next's static export output. Minified bundles, not source.
      '**/out/**',
      // next-env.d.ts is REGENERATED by every `next build`, complete with a
      // triple-slash reference to routes.d.ts that this config rejects — so
      // fixing the file cannot stick. Globbed rather than listed per app:
      // apps/web was already ignored, the marketplace was not, and CI failed on
      // the second Next app for a reason the first one had already documented.
      '**/next-env.d.ts',
    ],
  },
